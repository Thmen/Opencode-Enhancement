[Home](README.md) / Track team usage with analytics
...
| ----------------------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Claude for Teams / Enterprise | [claude.ai/analytics/claude-code](https://claude.ai/analytics/claude-code) | Usage metrics, contribution metrics with GitHub integration, leaderboard, data export | [Details](Getting started/02-ClaudeCodeoverview.md#access-analytics-for-teams-and-enterprise) |
| API (Claude Console)          | [platform.claude.com/claude-code](https://platform.claude.com/claude-code) | Usage metrics, spend tracking, team insights                                          | [Details](Getting started/02-ClaudeCodeoverview.md#access-analytics-for-api-customers)        |
...
* **Contribution metrics**: PRs and lines of code shipped with Claude Code assistance, with [GitHub integration](Getting started/02-ClaudeCodeoverview.md#enable-contribution-metrics)
...
<Warning>
  Contribution metrics are not available for organizations with [Zero Data Retention](55-Zerodataretention.md) enabled. The analytics dashboard will show usage metrics only.
</Warning>
...
* [Monitoring with OpenTelemetry](33-Monitoring.md): export real-time metrics and events to your observability stack
* [Manage costs effectively](12-Managecostseffectively.md): set spend limits and optimize token usage
* [Permissions](36-Configurepermissions.md): configure roles and permissions
