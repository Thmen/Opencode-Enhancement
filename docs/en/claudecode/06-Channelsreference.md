...
A channel published to your own marketplace still needs `--dangerously-load-development-channels` to run, since it isn't on the [approved allowlist](05-Pusheventsintoarunningsessionwithchannels.md#supported-channels). To get it added, [submit it to the official marketplace](38-Createplugins.md#submit-your-plugin-to-the-official-marketplace). Channel plugins go through security review before being approved.
