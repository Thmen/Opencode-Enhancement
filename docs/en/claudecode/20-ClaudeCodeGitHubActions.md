[Home](README.md) / Claude Code GitHub Actions

# Claude Code GitHub Actions

> Learn about integrating Claude Code into your development workflow with Claude Code GitHub Actions

Claude Code GitHub Actions brings AI-powered automation to your GitHub workflow. With a simple `@claude` mention in any PR or issue, Claude can analyze your code, create pull requests, implement features, and fix bugs - all while following your project's standards. For automatic reviews posted on every PR without a trigger, see [GitHub Code Review](10-CodeReview.md).
...
<Info>
  **Claude Opus 4.6 is now available.** Claude Code GitHub Actions default to Sonnet. To use Opus 4.6, configure the [model parameter](Getting started/02-ClaudeCodeoverview.md#breaking-changes-reference) to use `claude-opus-4-6`.
</Info>
...
<Note>
  ...
  * This quickstart method is only available for direct Claude API users. If
    ...
    Bedrock & Google Vertex AI](Getting started/02-ClaudeCodeoverview.md#using-with-aws-bedrock-%26-google-vertex-ai)
    section.
</Note>
...
* **Skills** - Invoke installed [skills](46-ExtendClaudewithskills.md) directly from the prompt
...
| ------------------- | ------------------------------------------------------------------ | -------- |
| `prompt`            | Instructions for Claude (plain text or a [skill](46-ExtendClaudewithskills.md) name) | No\*     |
