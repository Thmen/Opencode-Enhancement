[Home](README.md) / Enterprise network configuration
...
**Note:**
All environment variables shown on this page can also be configured in [`settings.json`](44-ClaudeCodesettings.md).
