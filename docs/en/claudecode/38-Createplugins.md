...
Looking to install existing plugins? See [Discover and install plugins](17-Discoverandinstallprebuiltpluginsthroughmarketplaces.md). For complete technical specifications, see [Plugins reference](39-Pluginsreference.md).
...
**Tip:**
Start with standalone configuration in `.claude/` for quick iteration, then [convert to a plugin](Getting started/02-ClaudeCodeoverview.md#convert-existing-configurations-to-plugins) when you're ready to share.
...
* Claude Code [installed and authenticated](Getting started/03-Quickstart.md#step-1-install-claude-code)
* Claude Code version 1.0.33 or later (run `claude --version` to check)

**Note:**
If you don't see the `/plugin` command, update Claude Code to the latest version. See [Troubleshooting](52-Troubleshooting.md) for upgrade instructions.
...
| `version`     | Track releases using [semantic versioning](39-Pluginsreference.md#version-management).                  |
| `author`      | Optional. Helpful for attribution.                                                                     |

For additional fields like `homepage`, `repository`, and `license`, see the [full manifest schema](39-Pluginsreference.md#plugin-manifest-schema).
...
Claude will greet you by name. For more on passing arguments to skills, see [Skills](46-ExtendClaudewithskills.md#pass-arguments-to-skills).
...
**Tip:**
The `--plugin-dir` flag is useful for development and testing. When you're ready to share your plugin with others, see [Create and distribute a plugin marketplace](37-Createanddistributeapluginmarketplace.md).
...
| `settings.json`   | Plugin root | Default [settings](44-ClaudeCodesettings.md) applied when the plugin is enabled            |

**Note:**
**Next steps**: Ready to add more features? Jump to [Develop more complex plugins](Getting started/02-ClaudeCodeoverview.md#develop-more-complex-plugins) to add agents, hooks, MCP servers, and LSP servers. For complete technical specifications of all plugin components, see [Plugins reference](39-Pluginsreference.md).
...
Plugins can include [Agent Skills](46-ExtendClaudewithskills.md) to extend Claude's capabilities. Skills are model-invoked: Claude automatically uses them based on the task context.
...
After installing the plugin, run `/reload-plugins` to load the Skills. For complete Skill authoring guidance including progressive disclosure and tool restrictions, see [Agent Skills](46-ExtendClaudewithskills.md).
...
For complete LSP configuration options, see [LSP servers](39-Pluginsreference.md#lsp-servers).
...
Setting `agent` activates one of the plugin's [custom agents](48-Createcustomsubagents.md) as the main thread, applying its system prompt, tool restrictions, and model. This lets a plugin change how Claude Code behaves by default when enabled.
...
For plugins with many components, organize your directory structure by functionality. For complete directory layouts and organization patterns, see [Plugin directory structure](39-Pluginsreference.md#plugin-directory-structure).
...
3. **Use validation and debugging tools**: See [Debugging and development tools](39-Pluginsreference.md#debugging-and-development-tools) for CLI commands and troubleshooting techniques
...
2. **Version your plugin**: Use [semantic versioning](39-Pluginsreference.md#version-management) in your `plugin.json`
3. **Create or use a marketplace**: Distribute through [plugin marketplaces](37-Createanddistributeapluginmarketplace.md) for installation
4. **Test with others**: Have team members test the plugin before wider distribution

Once your plugin is in a marketplace, others can install it using the instructions in [Discover and install plugins](17-Discoverandinstallprebuiltpluginsthroughmarketplaces.md).
...
**Note:**
For complete technical specifications, debugging techniques, and distribution strategies, see [Plugins reference](39-Pluginsreference.md).
...
* [Discover and install plugins](17-Discoverandinstallprebuiltpluginsthroughmarketplaces.md): browse marketplaces and install plugins
* [Configure team marketplaces](17-Discoverandinstallprebuiltpluginsthroughmarketplaces.md#configure-team-marketplaces): set up repository-level plugins for your team

### For plugin developers

* [Create and distribute a marketplace](37-Createanddistributeapluginmarketplace.md): package and share your plugins
* [Plugins reference](39-Pluginsreference.md): complete technical specifications
* Dive deeper into specific plugin components:
  * [Skills](46-ExtendClaudewithskills.md): skill development details
  * [Subagents](48-Createcustomsubagents.md): agent configuration and capabilities
  * [Hooks](24-Hooksreference.md): event handling and automation
  * [MCP](30-ConnectClaudeCodetotoolsviaMCP.md): external tool integration
