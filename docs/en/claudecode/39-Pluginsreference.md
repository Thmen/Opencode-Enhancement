[Home](README.md) / Plugins reference
...
**Tip:**
Looking to install plugins? See [Discover and install plugins](17-Discoverandinstallprebuiltpluginsthroughmarketplaces.md). For creating plugins, see [Plugins](38-Createplugins.md). For distributing plugins, see [Plugin marketplaces](37-Createanddistributeapluginmarketplace.md).
...
For complete details, see [Skills](46-ExtendClaudewithskills.md).
...
For complete details, see [Subagents](48-Createcustomsubagents.md).
...
Plugin hooks respond to the same lifecycle events as [user-defined hooks](24-Hooksreference.md):
...
| `managed` | [Managed settings](44-ClaudeCodesettings.md#settings-files) | Managed plugins (read-only, update only)                 |

Plugins use the same scope system as other Claude Code configurations. For installation instructions and scope flags, see [Install plugins](17-Discoverandinstallprebuiltpluginsthroughmarketplaces.md#install-plugins). For a complete explanation of scopes, see [Configuration scopes](44-ClaudeCodesettings.md#configuration-scopes).
...
The manifest is optional. If omitted, Claude Code auto-discovers components in [default locations](Getting started/02-ClaudeCodeoverview.md#file-locations-reference) and derives the plugin name from the directory name. Use a manifest when you need to provide metadata or custom component paths.
...
| `userConfig`   | object                | User-configurable values prompted at enable time. See [User configuration](Getting started/02-ClaudeCodeoverview.md#user-configuration)                                                           | See below                              |
| `channels`     | array                 | Channel declarations for message injection (Telegram, Slack, Discord style). See [Channels](Getting started/02-ClaudeCodeoverview.md#channels)                                                    | See below                              |
...
For `commands`, `agents`, `skills`, and `outputStyles`, custom paths replace the default directory. If the manifest specifies `commands`, the default `commands/` directory is not scanned. [Hooks](Getting started/02-ClaudeCodeoverview.md#hooks), [MCP servers](Getting started/02-ClaudeCodeoverview.md#mcp-servers), and [LSP servers](Getting started/02-ClaudeCodeoverview.md#lsp-servers) have different semantics for handling multiple sources.
...
The data directory is deleted automatically when you uninstall the plugin from the last scope where it is installed. The `/plugin` interface shows the directory size and prompts before deleting. The CLI deletes by default; pass [`--keep-data`](Getting started/02-ClaudeCodeoverview.md#plugin-uninstall) to preserve it.
...
| **Settings**      | `settings.json`              | Default configuration applied when the plugin is enabled. Only [`agent`](48-Createcustomsubagents.md) settings are currently supported |
...
| `--keep-data`         | Preserve the plugin's [persistent data directory](Getting started/02-ClaudeCodeoverview.md#persistent-data-directory) |         |
| `-h, --help`          | Display help for command                                                      |         |
...
If your plugin is within a [marketplace](37-Createanddistributeapluginmarketplace.md) directory, you can manage the version through `marketplace.json` instead and omit the `version` field from `plugin.json`.

***

## See also

* [Plugins](38-Createplugins.md) - Tutorials and practical usage
* [Plugin marketplaces](37-Createanddistributeapluginmarketplace.md) - Creating and managing marketplaces
...
* [Settings](44-ClaudeCodesettings.md) - Configuration options for plugins
