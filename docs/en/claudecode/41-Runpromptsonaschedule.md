[Home](README.md) / Run prompts on a schedule
...
Tasks are session-scoped: they live in the current Claude Code process and are gone when you exit. For durable scheduling that survives restarts, use [Cloud](54-Scheduletasksontheweb.md) or [Desktop](14-UseClaudeCodeDesktop.md#schedule-recurring-tasks) scheduled tasks, or [GitHub Actions](20-ClaudeCodeGitHubActions.md).
...
Set `CLAUDE_CODE_DISABLE_CRON=1` in your environment to disable the scheduler entirely. The cron tools and `/loop` become unavailable, and any already-scheduled tasks stop firing. See [Environment variables](18-Environmentvariables.md) for the full list of disable flags.
...
* [Cloud scheduled tasks](54-Scheduletasksontheweb.md): run on Anthropic-managed infrastructure
* [GitHub Actions](20-ClaudeCodeGitHubActions.md): use a `schedule` trigger in CI
* [Desktop scheduled tasks](14-UseClaudeCodeDesktop.md#schedule-recurring-tasks): run locally on your machine
