...
For detailed permission configuration, see [Permissions](36-Configurepermissions.md).

### Built-in protections

To mitigate risks in agentic systems:

* **Sandboxed bash tool**: [Sandbox](40-Sandboxing.md) bash commands with filesystem and network isolation, reducing permission prompts while maintaining security. Enable with `/sandbox` to define boundaries where Claude Code can work autonomously
...
* **Command blocklist**: Blocks risky commands that fetch arbitrary content from the web like `curl` and `wget` by default. When explicitly allowed, be aware of [permission pattern limitations](36-Configurepermissions.md#tool-specific-permission-rules)
...
* **Secure credential storage**: API keys and tokens are encrypted. See [Credential Management](04-Authentication.md#credential-management)
...
See [VS Code security and privacy](Platforms and integrations/06-UseClaudeCodeinVSCode.md#security-and-privacy) for more information on running Claude Code in an IDE.

## Cloud execution security

When using [Claude Code on the web](08-ClaudeCodeontheweb.md), additional security controls are in place:
...
* Consider using [devcontainers](16-Developmentcontainers.md) for additional isolation
* Regularly audit your permission settings with `/permissions`

### Team security

* Use [managed settings](44-ClaudeCodesettings.md#settings-files) to enforce organizational standards
* Share approved permission configurations through version control
* Train team members on security best practices
* Monitor Claude Code usage through [OpenTelemetry metrics](33-Monitoring.md)
* Audit or block settings changes during sessions with [`ConfigChange` hooks](24-Hooksreference.md#configchange)
...
* [Permissions](36-Configurepermissions.md) - Configure permissions and access controls
* [Monitoring usage](33-Monitoring.md) - Track and audit Claude Code activity
* [Development containers](16-Developmentcontainers.md) - Secure, isolated environments
