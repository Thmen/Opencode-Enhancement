[Home](README.md) / Customize your status line
...
Use the [`/statusline` command](Getting started/02-ClaudeCodeoverview.md#use-the-statusline-command) to have Claude Code generate a script for you, or [manually create a script](Getting started/02-ClaudeCodeoverview.md#manually-configure-a-status-line) and add it to your settings.
...
Claude Code runs your script and pipes [JSON session data](Getting started/02-ClaudeCodeoverview.md#available-data) to it via stdin. Your script reads the JSON, extracts what it needs, and prints text to stdout. Claude Code displays whatever your script prints.
...
* **Multiple lines**: each `echo` or `print` statement displays as a separate row. See the [multi-line example](Getting started/02-ClaudeCodeoverview.md#display-multiple-lines).
...
| `context_window.current_usage`                                                   | Token counts from the last API call, described in [context window fields](Getting started/02-ClaudeCodeoverview.md#context-window-fields)                                                                                            |
...
| `vim.mode`                                                                       | Current vim mode (`NORMAL` or `INSERT`) when [vim mode](26-Interactivemode.md#vim-editor-mode) is enabled                                                                                     |
...
3. Add the path to your [settings](Getting started/02-ClaudeCodeoverview.md#manually-configure-a-status-line)
...
* **Cache slow operations**: your script runs frequently during active sessions, so commands like `git status` can cause lag. See the [caching example](Getting started/02-ClaudeCodeoverview.md#cache-expensive-operations) for how to handle this.
