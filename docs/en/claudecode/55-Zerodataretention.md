[Home](README.md) / Zero data retention
...
* [Analytics](03-Trackteamusagewithanalytics.md) dashboard
* [Server-managed settings](43-Configureserver-managedsettings(publicbeta).md)
* Audit logs
...
ZDR does not extend to the following, even for organizations with ZDR enabled. These features follow [standard data retention policies](13-Datausage.md#data-retention):
...
| Claude Code Analytics    | Does not store prompts or model responses, but collects productivity metadata such as account emails and usage statistics. Contribution metrics are not available for ZDR organizations; the [analytics dashboard](03-Trackteamusagewithanalytics.md) shows usage metrics only. |
...
| Feature                                                             | Reason                                                                  |
| ------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [Claude Code on the Web](08-ClaudeCodeontheweb.md)                | Requires server-side storage of conversation history.                   |
| [Remote sessions](14-UseClaudeCodeDesktop.md#remote-sessions) from the Desktop app | Requires persistent session data that includes prompts and completions. |
