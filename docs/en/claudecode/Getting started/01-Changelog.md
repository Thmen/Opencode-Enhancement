[Home](../README.md) / [Getting started](README.md) / Changelog
...
* Added PowerShell tool for Windows as an opt-in preview. Learn more at [https://code.claude.com/docs/en/tools-reference#powershell-tool](../51-Toolsreference.md#powershell-tool)
...
* Managed settings can now be set via macOS plist or Windows Registry. Learn more at [https://code.claude.com/docs/en/settings#settings-files](../44-ClaudeCodesettings.md#settings-files)
...
* Fast mode is now available for Opus 4.6. Learn more at [https://code.claude.com/docs/en/fast-mode](../19-Speedupresponseswithfastmode.md)
...
* Added customizable keyboard shortcuts. Configure keybindings per context, create chord sequences, and personalize your workflow. Run `/keybindings` to get started. Learn more at [https://code.claude.com/docs/en/keybindings](../27-Customizekeyboardshortcuts.md)
...
* Added support for .claude/rules/\`.  See [https://code.claude.com/docs/en/memory](../Use Claude Code/03-HowClauderemembersyourproject.md) for details.
...
* Plugin documentation available at [https://code.claude.com/docs/en/plugins](../38-Createplugins.md)
...
* Released output styles, including new built-in educational output styles "Explanatory" and "Learning". Docs: [https://code.claude.com/docs/en/output-styles](../35-Outputstyles.md)
...
### 1.0.38 (June 30, 2025)
* Released hooks. Special thanks to community input in [https://github.com/anthropics/claude-code/issues/712](https://github.com/anthropics/claude-code/issues/712). Docs: [https://code.claude.com/docs/en/hooks](../24-Hooksreference.md)
