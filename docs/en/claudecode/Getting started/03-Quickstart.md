...
* A [Claude subscription](https://claude.com/pricing?utm_source=claude_code\&utm_medium=docs\&utm_content=quickstart_prereq) (Pro, Max, Teams, or Enterprise), [Claude Console](https://console.anthropic.com/) account, or access through a [supported cloud provider](../50-Enterprisedeploymentoverview.md)

**Note:**
This guide covers the terminal CLI. Claude Code is also available on the [web](https://claude.ai/code), as a [desktop app](../14-UseClaudeCodeDesktop.md), in [VS Code](../Platforms and integrations/06-UseClaudeCodeinVSCode.md) and [JetBrains IDEs](../Platforms and integrations/02-JetBrainsIDEs.md), in [Slack](../Platforms and integrations/05-ClaudeCodeinSlack.md), and in CI/CD with [GitHub Actions](../20-ClaudeCodeGitHubActions.md) and [GitLab](../21-ClaudeCodeGitLabCICD.md). See [all interfaces](02-ClaudeCodeoverview.md#use-claude-code-everywhere).
...
* [Amazon Bedrock, Google Vertex AI, or Microsoft Foundry](../50-Enterprisedeploymentoverview.md) (enterprise cloud providers)
...
**Tip:**
After logging in (Step 2), your credentials are stored on your system. Learn more in [Credential Management](../04-Authentication.md#credential-management).
...
See the [CLI reference](../09-CLIreference.md) for a complete list of commands.

## Pro tips for beginners

For more, see [best practices](../Use Claude Code/01-BestPracticesforClaudeCode.md) and [common workflows](../Use Claude Code/02-Commonworkflows.md).
...
- [How Claude Code works](../Core concepts/02-HowClaudeCodeworks.md): Understand the agentic loop, built-in tools, and how Claude Code interacts with your project

- [Best practices](../Use Claude Code/01-BestPracticesforClaudeCode.md): Get better results with effective prompting and project setup

- [Common workflows](../Use Claude Code/02-Commonworkflows.md): Step-by-step guides for common tasks

- [Extend Claude Code](../Core concepts/01-ExtendClaudeCode.md): Customize with CLAUDE.md, skills, hooks, MCP, and more
