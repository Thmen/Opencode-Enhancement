[Home](../README.md) / [Platforms and integrations](README.md) / Use Claude Code with Chrome (beta)
...
Claude Code integrates with the Claude in Chrome browser extension to give you browser automation capabilities from the CLI or the [VS Code extension](06-UseClaudeCodeinVSCode.md#automate-browser-tasks-with-chrome). Build your code, then test and debug in the browser without switching contexts.
...
For VS Code, see [browser automation in VS Code](06-UseClaudeCodeinVSCode.md#automate-browser-tasks-with-chrome).
...
* [Use Claude Code in VS Code](06-UseClaudeCodeinVSCode.md#automate-browser-tasks-with-chrome): browser automation in the VS Code extension
* [CLI reference](../09-CLIreference.md): command-line flags including `--chrome`
* [Common workflows](../Use Claude Code/02-Commonworkflows.md): more ways to use Claude Code
* [Data and privacy](../13-Datausage.md): how Claude Code handles your data
