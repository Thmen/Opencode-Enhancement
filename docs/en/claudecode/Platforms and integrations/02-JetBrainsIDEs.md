[Home](../README.md) / [Platforms and integrations](README.md) / JetBrains IDEs
...
* For WSL users, see the [WSL troubleshooting guide](../52-Troubleshooting.md#jetbrains-ide-not-detected-on-wsl2)
...
For additional help, see our [troubleshooting guide](../52-Troubleshooting.md).
