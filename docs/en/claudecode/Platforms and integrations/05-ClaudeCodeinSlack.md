[Home](../README.md) / [Platforms and integrations](README.md) / Claude Code in Slack
...
| Claude Code on the web | Access to [Claude Code on the web](../08-ClaudeCodeontheweb.md) must be enabled |
...
automatically visible to the organization. See [Claude Code on the Web sharing](../08-ClaudeCodeontheweb.md#sharing-sessions)
for more details.
...
- [Claude Code on the web](../08-ClaudeCodeontheweb.md): Learn more about Claude Code on the web
