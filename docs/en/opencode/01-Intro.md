...
For the best experience on Windows, we recommend using [Windows Subsystem for Linux (WSL)](07-Windows.md). It provides better performance and full compatibility with OpenCode’s features.
...
If you are new to using LLM providers, we recommend using [OpenCode Zen](Usage/06-Zen.md).
...
Alternatively, you can select one of the other providers. [Learn more](03-Providers.md#directory).
...
To make it your own, we recommend [picking a theme](Configure/05-Themes.md), [customizing the keybinds](Configure/06-Keybinds.md), [configuring code formatters](Configure/08-Formatters.md), [creating custom commands](Configure/07-Commands.md), or playing around with the [OpenCode config](02-Config.md).
