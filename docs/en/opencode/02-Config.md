...
[Learn more about TUI configuration here](Usage/02-TUI.md#configure).
...
[Learn more about the server here](Develop/02-Server.md).
...
[Learn more about tools here](Configure/01-Tools.md).
...
You can also configure [local models](Configure/04-Models.md#local). [Learn more](Configure/04-Models.md).
...
Bearer tokens (`AWS_BEARER_TOKEN_BEDROCK` or `/connect`) take precedence over profile-based authentication. See [authentication precedence](03-Providers.md#authentication-precedence) for details.

[Learn more about Amazon Bedrock configuration](03-Providers.md#amazon-bedrock).
...
[Learn more here](Configure/05-Themes.md).
...
You can also define agents using markdown files in `~/.config/opencode/agents/` or `.opencode/agents/`. [Learn more here](Configure/03-Agents.md).
...
The default agent must be a primary agent (not a subagent). This can be a built-in agent like `"build"` or `"plan"`, or a [custom agent](Configure/03-Agents.md) you’ve defined. If the specified agent doesn’t exist or is a subagent, OpenCode will fall back to `"build"` with a warning.
...
You can configure the [share](Usage/07-Share.md) feature through the `share` option.
...
You can also define commands using markdown files in `~/.config/opencode/commands/` or `.opencode/commands/`. [Learn more here](Configure/07-Commands.md).
...
[Learn more here](Configure/06-Keybinds.md).
...
[Learn more about formatters here](Configure/08-Formatters.md).
...
[Learn more about permissions here](Configure/09-Permissions.md).
...
[Learn more here](Configure/11-MCPservers.md).

---

### Plugins

[Plugins](Develop/03-Plugins.md) extend OpenCode with custom tools, hooks, and integrations.
...
[Learn more here](Develop/03-Plugins.md).
...
about rules here](Configure/02-Rules.md).
