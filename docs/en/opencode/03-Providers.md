...
tested and verified to work well with OpenCode. [Learn more](Usage/06-Zen.md).
...
You can also specify ‘GITLAB\_TOKEN’ environment variable if you don’t want
...
OpenCode Zen is a list of tested and verified models provided by the OpenCode team. [Learn more](Usage/06-Zen.md).
...
* **apiKey**: Set using `env` variable syntax, [learn more](02-Config.md#env-vars).
