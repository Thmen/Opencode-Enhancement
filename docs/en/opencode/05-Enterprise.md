...
OpenCode is open source and does not store any of your code or context data, so your developers can simply [get started](01-Intro.md) and carry out a trial.
...
[Learn more about sharing](Usage/07-Share.md).
