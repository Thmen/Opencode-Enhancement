...
If you’re experiencing slow performance, file access issues, or terminal problems on Windows, try using [WSL (Windows Subsystem for Linux)](07-Windows.md). WSL provides a Linux environment that works more seamlessly with OpenCode’s features.
...
1. First, verify your provider is set up correctly by following the [providers guide](03-Providers.md)
...
### AI\_APICallError and provider package issues
