[Home](../README.md) / [Configure](README.md) / Tools

# Tools

Manage the tools an LLM can use.

Tools allow the LLM to perform actions in your codebase. OpenCode comes with a set of built-in tools, but you can extend it with [custom tools](14-CustomTools.md) or [MCP servers](11-MCPservers.md).

By default, all tools are **enabled** and don’t need permission to run. You can control tool behavior through [permissions](09-Permissions.md).
...
[Learn more](09-Permissions.md) about configuring permissions.
...
To configure which LSP servers are available for your project, see [LSP Servers](10-LSPServers.md).
...
Load a [skill](13-AgentSkills.md) (a `SKILL.md` file) and return its content in the conversation.
...
This tool is disabled for subagents by default, but you can enable it manually. [Learn more](03-Agents.md#permissions)
...
[Learn more](14-CustomTools.md) about creating custom tools.
...
[Learn more](11-MCPservers.md) about configuring MCP servers.
