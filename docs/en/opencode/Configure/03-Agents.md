[Home](../README.md) / [Configure](README.md) / Agents
...
If you don’t specify a model, primary agents use the [model globally configured](../02-Config.md#models) while subagents will use the model of the primary agent that invoked the subagent.
...
The model ID in your OpenCode config uses the format `provider/model-id`. For example, if you’re using [OpenCode Zen](../Usage/06-Zen.md), you would use `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
...
[Learn more about tools](01-Tools.md).
...
[Learn more about permissions](09-Permissions.md).
