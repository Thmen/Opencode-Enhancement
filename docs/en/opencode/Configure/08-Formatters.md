[Home](../README.md) / [Configure](README.md) / Formatters
...
| oxfmt (Experimental) | .js, .jsx, .ts, .tsx | `oxfmt` dependency in `package.json` and an [experimental env variable flag](../Usage/03-CLI.md#experimental) |
