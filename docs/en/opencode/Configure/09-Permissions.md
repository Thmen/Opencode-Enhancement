[Home](../README.md) / [Configure](README.md) / Permissions
...
You can override permissions per agent. Agent permissions are merged with the global config, and agent rules take precedence. [Learn more](03-Agents.md#permissions) about agent permissions.
