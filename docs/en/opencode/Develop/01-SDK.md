[Home](../README.md) / [Develop](README.md) / SDK
...
[Learn more](02-Server.md) about how the server works. For examples, check out the [projects](04-Ecosystem.md#projects) built by the community.
