[Home](../README.md) / [Develop](README.md) / Plugins
...
For examples, check out the [plugins](04-Ecosystem.md#plugins) created by the community.
...
Browse available plugins in the [ecosystem](04-Ecosystem.md#plugins).
...
**Local plugins** are loaded directly from the plugin directory. To use external packages, you must create a `package.json` within your config directory (see [Dependencies](#dependencies)), or publish the plugin to npm and [add it to your config](../02-Config.md#plugins).
...
Levels: `debug`, `info`, `warn`, `error`. See [SDK documentation](01-SDK.md) for details.
