[Home](../README.md) / [Usage](README.md) / TUI
...
Most commands also have keybind using `ctrl+x` as the leader key, where `ctrl+x` is the default leader key. [Learn more](../Configure/06-Keybinds.md).
...
Create or update `AGENTS.md` file. [Learn more](../Configure/02-Rules.md).
...
Share current session. [Learn more](07-Share.md).
...
Unshare current session. [Learn more](07-Share.md#un-sharing).
...
* `theme` - Sets your UI theme. [Learn more](../Configure/05-Themes.md).
* `keybinds` - Customizes keyboard shortcuts. [Learn more](../Configure/06-Keybinds.md).
