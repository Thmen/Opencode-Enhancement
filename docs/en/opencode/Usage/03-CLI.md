[Home](../README.md) / [Usage](README.md) / CLI

# CLI

OpenCode CLI options and commands.

The OpenCode CLI by default starts the [TUI](02-TUI.md) when run without any arguments.
...
This sets up the necessary GitHub Actions workflow and guides you through the configuration process. [Learn more](08-GitHub.md).
...
This is useful for figuring out the exact model name to use in [your config](../02-Config.md).
...
Start a headless OpenCode server for API access. Check out the [server docs](../Develop/02-Server.md) for the full HTTP interface.
