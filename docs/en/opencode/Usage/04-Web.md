[Home](../README.md) / [Usage](README.md) / Web
...
For the best experience, run `opencode web` from [WSL](../07-Windows.md) rather than PowerShell. This ensures proper file system access and terminal integration.

---

## Configuration

You can configure the web server using command line flags or in your [config file](../02-Config.md).
