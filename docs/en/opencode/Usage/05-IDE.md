[Home](../README.md) / [Usage](README.md) / IDE
...
If on the other hand you want to use your own IDE when you run `/editor` or `/export` from the TUI, you’ll need to set `export EDITOR="code --wait"`. [Learn more](02-TUI.md#editor-setup).
