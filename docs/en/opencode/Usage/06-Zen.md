[Home](../README.md) / [Usage](README.md) / Zen
...
The [model id](../02-Config.md#models) in your OpenCode config
...
You might notice *Claude Haiku 3.5* in your usage history. This is a [low cost model](../02-Config.md#models) that’s used to generate the titles of your sessions.
