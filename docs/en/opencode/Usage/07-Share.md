...
To explicitly set manual mode in your [config file](../02-Config.md):
...
You can enable automatic sharing for all new conversations by setting the `share` option to `"auto"` in your [config file](../02-Config.md):
...
You can disable sharing entirely by setting the `share` option to `"disabled"` in your [config file](../02-Config.md):
...
[Learn more](../05-Enterprise.md) about using opencode in your organization.
