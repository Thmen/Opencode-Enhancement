...
| ----------------------------- | -------------------------------------------------------------------------- | ------------------------------ | ------------------------------------------------ |
| Claude for Teams / Enterprise | [claude.ai/analytics/claude-code](https://claude.ai/analytics/claude-code) | 使用指标、带 GitHub 集成的贡献指标、排行榜、数据导出 | [详情](快速开始/01-ClaudeCode概述.md#access-analytics-for-teams-and-enterprise) |
| API (Claude Console)          | [platform.claude.com/claude-code](https://platform.claude.com/claude-code) | 使用指标、支出跟踪、团队洞察                 | [详情](快速开始/01-ClaudeCode概述.md#access-analytics-for-api-customers)        |
...
* **贡献指标**：使用 Claude Code 协助的 PR 和已发布的代码行数，带有 [GitHub 集成](快速开始/01-ClaudeCode概述.md#enable-contribution-metrics)
...
<Warning>
  启用了 [Zero Data Retention](53-零数据保留.md) 的组织无法使用贡献指标。分析仪表板将仅显示使用指标。
</Warning>
...
* [使用 OpenTelemetry 进行监控](32-监控.md)：将实时指标和事件导出到您的可观测性堆栈
* [有效管理成本](11-有效管理成本.md)：设置支出限制并优化令牌使用
* [权限](35-配置权限.md)：配置角色和权限
