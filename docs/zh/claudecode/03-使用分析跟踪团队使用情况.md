...
**Warning:**
启用了 [Zero Data Retention](56-零数据保留.md) 的组织无法使用贡献指标。分析仪表板将仅显示使用指标。
...
* [使用 OpenTelemetry 进行监控](34-监控.md)：将实时指标和事件导出到您的可观测性堆栈
* [有效管理成本](13-有效管理成本.md)：设置支出限制并优化令牌使用
* [权限](37-配置权限.md)：配置角色和权限
