...
* 在您的[用户设置文件](45-ClaudeCode设置.md)中设置 `"fastMode": true`
...
您可以结合两者：在直接任务上使用快速模式和较低的[努力级别](33-模型配置.md#adjust-effort-level)以获得最大速度。
...
* [模型配置](33-模型配置.md)：切换模型并调整努力级别
* [有效管理成本](13-有效管理成本.md)：跟踪令牌使用情况并降低成本
* [状态行配置](48-自定义你的状态行.md)：显示模型和上下文信息
