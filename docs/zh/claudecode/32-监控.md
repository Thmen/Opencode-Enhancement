...
管理员可以通过 [托管设置文件](43-ClaudeCode设置.md#settings-files) 为所有用户配置 OpenTelemetry 设置。这允许在整个组织中集中控制遥测设置。有关设置如何应用的更多信息，请参阅 [设置优先级](43-ClaudeCode设置.md#settings-precedence)。
