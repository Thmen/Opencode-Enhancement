...
<Tip>
  想要安装插件？请参阅[发现和安装插件](16-通过市场发现和安装预构建插件.md)。如需创建插件，请参阅[Plugins](37-创建插件.md)。如需分发插件，请参阅[Plugin marketplaces](36-创建和分发pluginmarketplace.md)。
</Tip>
...
有关完整详情，请参阅[Skills](45-使用skills扩展Claude.md)。
...
有关完整详情，请参阅[Subagents](47-创建自定义subagents.md)。
...
| `managed` | [Managed settings](43-ClaudeCode设置.md#settings-files) | 托管 plugins（只读，仅更新）       |

Plugins 使用与其他 Claude Code 配置相同的范围系统。有关安装说明和范围标志，请参阅[安装 plugins](16-通过市场发现和安装预构建插件.md#install-plugins)。有关范围的完整说明，请参阅[Configuration scopes](43-ClaudeCode设置.md#configuration-scopes)。
...
| **设置**          | `settings.json`              | 启用 plugin 时应用的默认配置。目前仅支持[`agent`](47-创建自定义subagents.md)设置 |
...
<Warning>
  ...
  如果您的 plugin 在[市场](36-创建和分发pluginmarketplace.md)目录中，您可以通过 `marketplace.json` 管理版本，而不是从 `plugin.json` 中省略 `version` 字段。
</Warning>
...
* [Plugins](37-创建插件.md) - 教程和实际用法
* [Plugin marketplaces](36-创建和分发pluginmarketplace.md) - 创建和管理市场
* [Skills](45-使用skills扩展Claude.md) - Skill 开发详情
* [Subagents](47-创建自定义subagents.md) - Agent 配置和功能
* [Hooks](23-Hooks参考.md) - 事件处理和自动化
* [MCP](29-通过MCP将ClaudeCode连接到工具.md) - 外部工具集成
* [Settings](43-ClaudeCode设置.md) - Plugins 的配置选项
