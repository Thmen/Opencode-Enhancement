...
* [服务器管理的设置](44-配置服务器管理的设置（公开测试版）.md)
* 审计日志
...
ZDR 不适用于以下内容，即使对于启用了 ZDR 的组织也是如此。这些功能遵循[标准数据保留政策](14-数据使用.md#data-retention)：
...
| 功能                                                   | 原因                       |
| ---------------------------------------------------- | ------------------------ |
| [网络上的 Claude Code](09-ClaudeCodeontheweb.md)    | 需要服务器端存储对话历史。            |
| 来自 Desktop 应用的[远程会话](15-使用ClaudeCodeDesktop.md#remote-sessions) | 需要包含提示和完成的持久会话数据。        |
