...
如果你在 Windows 上遇到性能缓慢、文件访问问题或终端问题，请尝试使用 [WSL (Windows Subsystem for Linux)](07-Windows.md)。WSL 提供了一个 Linux 环境，能更好地与 OpenCode 的功能兼容。
...
1. 首先，按照[提供商指南](03-提供商.md)验证你的提供商是否已正确设置
