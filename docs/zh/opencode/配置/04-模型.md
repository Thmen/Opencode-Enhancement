...
这里完整的 ID 格式为 `provider_id/model_id`。例如，如果你使用 [OpenCode Zen](../使用/06-Zen.md)，则 GPT 5.1 Codex 对应的值为 `opencode/gpt-5.1-codex`。
...
你还可以为使用中的任何代理配置这些选项。代理配置会覆盖此处的全局选项。[了解更多](03-代理.md#additional)。
...
使用快捷键 `variant_cycle` 可以快速在变体之间切换。[了解更多](06-快捷键.md)。
